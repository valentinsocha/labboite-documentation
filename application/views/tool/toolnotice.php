                    ...
                    <div class="tool-notice">
                        <div class="p-6">
                            ...
                            <div class="step-level-1">
                                <h2 class="mb-4">Obtenir un modèle 3D</h2>
                            ...
                            <div class="step-level-1">
                                <h2 class="mb-4">Préparer son impression</h2>
                                ...
                                <div class="step-level-2 mt-8">
                                    <h3 class="mb-4">Éditer votre objet</h3>
                                ...
                                <div class="step-level-2 mt-8">
                                    <h3 class="mb-4">Régler les paramètres d’impression</h3>
                                ...
                                <div class="step-level-2 mt-8">
                                    <h3 class="mb-4">Finaliser le fichier d’impression</h3>
                            ...
                            <div class="step-level-1">
                                <h2 class="mb-4">Imprimer son objet</h2>
                                ...
                                <div class="step-level-2 mt-8">
                                    <h3 class="mb-4">Installer son filament</h3>
                                ...
                                <div class="step-level-2 mt-8">
                                    <h3 class="mb-4">Lancer son impression</h3>
                                ...
                                <div class="step-level-2 mt-8">
                                    <h3 class="mb-4">Récupération de l’impression</h3>
